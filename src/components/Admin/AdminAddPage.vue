      ...
      <div class="form-table-box">
        ...
        >
          ...
          <!-- <el-form-item label="新密码" v-if="infoForm.id" prop="newpassword">
            <el-switch v-model="change" active-color="#13ce66"> </el-switch>
          </el-form-item> -->
          ...
          <el-form-item>
            <el-button
              ...
              >确定保存</el-button
            >
            <el-button v-else type="primary" @click="addAdminInfo"
              >确定添加</el-button
            >
...
export default {
  ...
  methods: {
    ...
    //   if (
    //     password != undefined &&
    //     password.replace(/(^\s*)|(\s*$)/g, "").length < 6
    //   ) {
    //     this.$message({
    //       type: "error",
    //       message: "密码请大于6个字符",
  ...
  mounted() {
    ...
    this.infoForm.username = this.$route.query.name;
